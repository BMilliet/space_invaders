...
enum Inventory {
    ...
    static func getBullet2(col: Int, row: Int) -> Swift2DShape {
        ...
        return Swift2DShape(id: "enemyBullet_\(UUID())", matrix: matrix, column: col, row: row)
    ...
    static func getBullet1(col: Int, row: Int) -> Swift2DShape {
        ...
        return Swift2DShape(id: "bullet_\(UUID())", matrix: matrix, column: col, row: row)
    }
    ...
    static func getTank() -> Swift2DShape {
        ...
        return Swift2DShape(id: "tank", matrix: matrix, column: GAME_SCALE/2, row: GAME_SCALE - matrix.count)
    }
    ...
    static func getEnemies() -> [Swift2DShape] {
        ...
        for l in 0..<5 {
            ...
            for i in 0..<9 {
                ...
                let enemy = Swift2DShape(id: "enemy_line_\(l)_id_\(i)", matrix: matrix, column: col, row: row)
    ...
    static func getBases() -> [Swift2DShape] {
        ...
        for i in 0..<4 {
            ...
            let base = Swift2DShape(id: "base_\(i)", matrix: matrix, column: col, row: row)
            bases.append(base)
        }
